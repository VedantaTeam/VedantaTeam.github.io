const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/MemesVsZombies_Web_MirraGames.loader.js",
        dataURL: "bin/MemesVsZombies_Web_MirraGames.data",
        frameworkURL: "bin/MemesVsZombies_Web_MirraGames.framework.js",
        workerURL: "",
        codeURL: "bin/MemesVsZombies_Web_MirraGames.wasm",
        symbolsURL: "",
