const runtimeData = (function () {
    ...
    return {
        ...
        dataURL: "bin/MemesVsZombies_Web_Generic.data.unityweb",
        frameworkURL: "bin/MemesVsZombies_Web_Generic.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/MemesVsZombies_Web_Generic.wasm.unityweb",
        symbolsURL: "",
