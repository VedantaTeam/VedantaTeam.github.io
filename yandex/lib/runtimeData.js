const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/MemesVsZombies_Web_YandexGames.loader.js",
        dataURL: "bin/MemesVsZombies_Web_YandexGames.data",
        frameworkURL: "bin/MemesVsZombies_Web_YandexGames.framework.js",
        workerURL: "",
        codeURL: "bin/MemesVsZombies_Web_YandexGames.wasm",
        symbolsURL: "",
